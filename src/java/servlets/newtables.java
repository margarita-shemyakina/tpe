 ...
 */
@WebServlet( urlPatterns = {"/newtables"})
public class newtables extends HttpServlet {
 @EJB
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String imya = (String) request.getParameter("name");
        Studentyi student=stServ.getStudent(Long.valueOf(imya));
        ...
        RequestDispatcher dispatcher = request.getServletContext()
                .getRequestDispatcher("/WEB-INF/newtables.jsp");
